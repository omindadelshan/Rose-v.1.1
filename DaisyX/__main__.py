...
ʜɪᴛ /help ᴛ ꜰɪɴᴅ ᴍʏ ʟɪꜱᴛ ᴏꜰ ᴀᴠᴀɪʟᴀʙʟᴇ ᴄᴏᴍᴍᴀɴᴅꜱ
"""
...
buttons = [
    [
        InlineKeyboardButton(text="⁉️ ᴄᴏᴍᴍᴀɴᴅꜱ ʜᴇʟᴘ ⁉️", callback_data="help_back")
    ],
    [
        InlineKeyboardButton(text="💻 ꜱʏꜱᴛᴇᴍ ꜱᴛᴀᴛꜱ 💻", callback_data="stats_callback")
    ],
    [
        InlineKeyboardButton(text="🔱 ɪɴꜰᴏ 🔱", callback_data="aboutmanu_"),
    
        InlineKeyboardButton(text="👨‍⚖️ ᴅᴇᴠᴇʟᴏᴏᴘᴇʀ 👨‍⚖️", url="t.me/omindas"),
    ],   
    [
        InlineKeyboardButton(text="📣 ᴄʜᴀɴɴᴀʟ 📣", url="t.me/szbots"),
    
        InlineKeyboardButton(text="⚡ ɢʀᴏᴜᴏᴘ ⚡", url="t.me/tgbotschatzone"),
    ],      
    [
        InlineKeyboardButton(
...
Sticker = "CAACAgUAAxkBAAIHIWE8SN1EYVJgH-SikeN11hyp3vvFAAJoAwACpN3hVY-_RaBzX8DZIAQ"

HELP_STRINGS = f"""
*ᴍᴀɪɴ ᴄᴏᴍᴍᴀɴᴅꜱ :* [Sticker](CAACAgUAAx0CWoqChwACBFxhO1tG5S1ZM8xX5eSF9nNbve5b1AACaAMAAqTd4VWPv0Wgc1_A2SAE)
...
DONATE_STRING = """☠️ Heya, glad to hear you want to donate!
You can donate to the original writer's of the Base code,
Support them  [Ominda](t.me/omindas),[Ominda](t.me/GroupsMusicPlugin21) 💝,"""
